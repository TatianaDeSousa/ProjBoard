                ...
                <div className="relative z-10">
                  ...
                  <div className="space-y-4 mb-6">
                    ...
                    <div className="h-3 w-full bg-slate-50 rounded-full p-0.5 overflow-hidden shadow-inner flex ring-1 ring-slate-100">
                      <div className="h-full rounded-full gradient-primary transition-all duration-[1000ms]" style={{ width: `${progress}%` }} />
                    </div>
                  </div>
                </div>
...
const Dashboard = () => {
  ...
  return (
    <div className="container mx-auto px-6 py-12 animate-in max-w-7xl pb-40">
                  ...
                  <Card className="p-8 border-none bg-red-500 text-white rounded-[2.5rem] shadow-2xl shadow-red-500/30 ring-4 ring-red-100 flex items-center justify-between hover:scale-[1.02] transition-all">
                     <div className="flex items-center gap-6">
                        ...
                        <div>
                           ...
                           <p className="text-xs font-black uppercase tracking-widest opacity-70">Priorité Immédiate • Score {calculateHealthScore(p)}</p>
                        </div>
                     </div>
      ...
      {/* PLAN D'ATTAQUE IA RESTAURÉ v2.8 */}
      <div className="mb-24 px-4">
         <h3 className="text-xs font-black uppercase tracking-[0.4em] text-slate-300 mb-8 flex items-center gap-3 italic"><Target size={18} className="text-primary" /> Plan d'Attaque IA</h3>
         <AIAttackPlan projects={projects} />
      </div>

      {/* SECTION SANTÉ DES PROJETS v2.8 */}
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 mb-24 px-4">
         <div className="lg:col-span-12 xl:col-span-8 flex flex-col">
            <h3 className="text-xs font-black uppercase tracking-[0.4em] text-slate-300 mb-8 flex items-center gap-3 italic"><HeartPulse size={18} className="text-primary" /> Tableau Tactique de Vitalité</h3>
               ...
               {healthFocus.map(p => {
                 ...
                 return (
                   <Card key={p.id} className={cn(
                     ...
                     score < 40 ? "bg-red-50 ring-2 ring-red-100 shadow-red-500/5" : "bg-white"
                   )}>
                      <div>
         ...
         <div className="xl:col-span-4 flex flex-col h-full">
            <h3 className="text-xs font-black uppercase tracking-[0.4em] text-slate-300 mb-8 flex items-center gap-3 italic"><StickyNote size={18} /> Notes Tactiques</h3>
            <QuickNotes />
         </div>
      </div>
      ...
      <div className="px-4 space-y-24">
         ...
         <div className="flex flex-col h-full">
            <h3 className="text-xs font-black uppercase tracking-[0.4em] text-slate-300 mb-8 flex items-center gap-3 italic"><Calendar size={18} /> Chronologie d'Affaires</h3>
